...
// 1. get count of rooms using user_id
chatSchema.statics.countByUserId = function(user_id) {
...
// Create Model & Export
module.exports = mongoose.model('tbl_chat_rooms_by_users', chatSchema); //collection name : tbl_chat_rooms_by_users